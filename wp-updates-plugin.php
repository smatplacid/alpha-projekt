...
new WPUpdatesPluginUpdater_1376( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_1376') ) {
    class WPUpdatesPluginUpdater_1376 {
